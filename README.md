...
`0.4.6-c3.13` 后连接 ESP32-C3。当前 Web 固件已在上述成品板实机点亮；普通升级（不勾选
...
- **想换桌宠**：右键托盘图标 → 「桌宠外观」可选经典宠物 / 咖色边牧并调大小；也可进
  「更换桌宠动画…」从 petdex 挑选后上传。
